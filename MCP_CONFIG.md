...
- **Root directory**: /Users/bcg83269/project/java/osl/osl-mm-match
- **Server command**:
```bash
npx @modelcontextprotocol/server-filesystem --path "/Users/bcg83269/project/java/osl/osl-mm-match"
```

## 2. GitHub MCP (optional)
- **Purpose**: Efficient issue management, pull request creation, and repository analysis
- **Repository**: git@gitlab.glb.osl-nucleus.com:tech/dev/be/lp/osl-mm-match.git
...
```
claude mcp add github --transport http "git@gitlab.glb.osl-nucleus.com:tech/dev/be/lp/osl-mm-match.git"
```
...
- **Server command**:
```bash
npx @modelcontextprotocol/server-git --path "/Users/bcg83269/project/java/osl/osl-mm-match"
```
