...
public class GlobalADLService {
    ...
    /**
     * snapshots[shardId] = symbol -> [(factor,position)...]
     * 用于“候选提示”
     */
    ...
    public MutableList<LongObjectPair<SymbolPositionRecord>> getShardCandidates(int shardId, int symbol) {
        IntObjectHashMap<MutableList<LongObjectPair<SymbolPositionRecord>>> m = snapshots[shardId];
