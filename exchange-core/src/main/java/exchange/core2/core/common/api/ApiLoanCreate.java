...
/**
 * LOAN_CREATE —— 单笔 Isolated loan 建仓（详见 loan.md §5.2）。字段映射到 OrderCommand：transactionId → orderId、 loanId →
...
public class ApiLoanCreate extends ApiCommand {
    ...
    public String toString() {
        return "[LOAN_CREATE ext" + transactionId + " u" + uid + " id" + loanId + " s" + symbol + " col="
