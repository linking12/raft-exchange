 ...
 * targetLoanId 从 pickLoanToRepay tiebreak 选出。preProcess 阶段 pre-move sellingCurrency 抵押到 exchangeLocked， post-process 阶段
 * quote proceeds 优先偿付 targetLoan (interest → principal)，剩余 overpay 留在账户。
 */
@Builder
