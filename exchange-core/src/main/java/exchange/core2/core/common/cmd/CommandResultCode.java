...
public enum CommandResultCode {
    ...
    // 内部转账：from == to 自转
    INTERNAL_TRANSFER_INVALID_SELF(-4301),
    ...
    LOAN_COLLATERAL_NOT_ALLOWED(-6031),               // currencySpec.collateralWeightBps == 0（Cross 抵押白名单）
    ...
    LOAN_IF_INSUFFICIENT(-6053),                      // LOAN_IF_WITHDRAW 提取超过 LIF 该币种余额
