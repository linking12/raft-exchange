...
class RiskEngineCalculateLockedTest {
    ...
    private static final int SYMBOL_BTC_USDT = 2001; // 已注册的 BTC/USDT 现货 pair；loan record 的 symbolId 占位
    ...
    void setUp() {
        ...
        CoreCurrencySpecification btc =
            CoreCurrencySpecification.builder().id(BTC).name("BTC").digit(0).collateralWeightBps(9000).build();
        ...
        CoreSymbolSpecification spotSpec = CoreSymbolSpecification.builder()
                ...
                .loanConfig(SymbolLoanSpecification.builder()
                        .initialLtvBps(6000).liquidationLtvBps(8000).build())
                .build();
    ...
    void calculateLocked_isolatedLoanCollateralOnly_includedForCollateralCurrencyOnly() {
        ...
        IsolatedLoanRecord btcLoan = new IsolatedLoanRecord(UID, 100L, SYMBOL_BTC_USDT, BTC, USDT, 500, 0L);
        btcLoan.collateralAmount = 3L;
        btcLoan.outstandingPrincipal = 30_000L;
        up.isolatedLoans.put(100L, btcLoan);

        IsolatedLoanRecord ethLoan = new IsolatedLoanRecord(UID, 101L, SYMBOL_BTC_USDT, ETH, USDT, 500, 0L);
    ...
    void calculateLocked_multipleIsolatedLoansSameCollateralCurrency_summed() {
        IsolatedLoanRecord loan1 = new IsolatedLoanRecord(UID, 100L, SYMBOL_BTC_USDT, BTC, USDT, 500, 0L);
        loan1.collateralAmount = 3L;
        up.isolatedLoans.put(100L, loan1);
        IsolatedLoanRecord loan2 = new IsolatedLoanRecord(UID, 101L, SYMBOL_BTC_USDT, BTC, USDT, 500, 0L);
    ...
    void calculateLocked_futuresMarginPlusLoanCollateral_summedIntoQuoteAndBase() {
        ...
        IsolatedLoanRecord loan = new IsolatedLoanRecord(UID, 100L, SYMBOL_BTC_USDT, BTC, USDT, 500, 0L);
    ...
    void calculateLocked_isolatedLoanWithZeroCollateral_contributesZero() {
        ...
        IsolatedLoanRecord empty = new IsolatedLoanRecord(UID, 100L, SYMBOL_BTC_USDT, BTC, USDT, 500, 0L);
