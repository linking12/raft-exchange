...
class ITLoanDynamicRate {
    ...
    private void createLoan(ExchangeTestContainer c, long extId, long loanId, long principal, byte rateMode)
        ...
        c.submitCommandSync(ApiLoanCreate.builder()
            .transactionId(extId).uid(BORROWER).loanId(loanId).symbol(SYMBOL)
    ...
    public void ofMarket_derivesThresholds_borrowRespectsDerivedInitialLtv() throws Exception {
        try (ExchangeTestContainer c = boot(200, 0)) {
            ...
            c.submitCommandSync(ApiLoanCreate.builder()
                .transactionId(1_000_050L).uid(BORROWER).loanId(50L).symbol(SYMBOL)
    ...
    public void ofMarket_borrowAboveDerivedInitialLtv_rejected() throws Exception {
        try (ExchangeTestContainer c = boot(200, 0)) {
            ...
            c.submitCommandSync(ApiLoanCreate.builder()
                .transactionId(1_000_051L).uid(BORROWER).loanId(51L).symbol(SYMBOL)
