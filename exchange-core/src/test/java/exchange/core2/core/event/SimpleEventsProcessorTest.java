...
public final class SimpleEventsProcessorTest {
    ...
    public void shouldHandleSimpleCommand() {
        ...
        cmd.takerFundEvents = new FundEvent(false, FundEvent.FundEventType.LOCKED, 0L, 0L, 0, 0L, 0L, 0L, 1, 0L, 0L, null, 0, 0, 0, 0, 0, 0, 0, 0, 0, null, 0, 0, 0, 0, 0, (byte) 0, 0L, 0L, 0L, 0L, 0L, 0, 0L, 0L, 0L, 0L, null);
        cmd.takerFundEvents.nextEvent = new FundEvent(false, FundEvent.FundEventType.UNLOCKED, 0L, 0L, 0, 0L, 0L, 0L, 1, 0L, 0L, null, 0, 0, 0, 0, 0, 0, 0, 0, 0, null, 0, 0, 0, 0, 0, (byte) 0, 0L, 0L, 0L, 0L, 0L, 0, 0L, 0L, 0L, 0L, null);
    ...
    public void shouldHandleWithSingleTrade() {
        ...
        cmd.takerFundEvents = new FundEvent(false, FundEvent.FundEventType.LOCKED, 10L, 100L, 10, 1000L, 0L, 10L, 1, 1000L, 1000L, null, 0, 0, 0, 0, 0, 0, 0, 0, 0, null, 0, 0, 0, 0, 0, (byte) 0, 0L, 0L, 0L, 0L, 0L, 0, 0L, 0L, 0L, 0L, null);
        cmd.takerFundEvents.nextEvent = new FundEvent(false, FundEvent.FundEventType.UNLOCKED, 10L, 100L, 10, 1000L, 0L, 10L, 1, 1000L, 10000L, PositionDirection.LONG, 1, 2, 3, 4, 5, 6, 7, 8, 9, MarginMode.ISOLATED, 10, 11, 12, 13, 14, (byte) 0, 0L, 0L, 0L, 0L, 0L, 0, 0L, 0L, 0L, 0L, null);
