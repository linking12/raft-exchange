...
public final class SimpleEventsProcessorTest {
    ...
    @Captor
    private ArgumentCaptor<IEventsHandler4Test.ApiCommandResult> commandResultCaptor;

    @Captor
    private ArgumentCaptor<IEventsHandler4Test.ReduceEvent> reduceEventCaptor;

    @Captor
    private ArgumentCaptor<IEventsHandler4Test.TradeEvent> tradeEventCaptor;

    @Captor
    private ArgumentCaptor<IEventsHandler4Test.FundsEvent> fundEventCaptor;

    @Captor
    private ArgumentCaptor<IEventsHandler4Test.RejectEvent> rejectEventCaptor;
