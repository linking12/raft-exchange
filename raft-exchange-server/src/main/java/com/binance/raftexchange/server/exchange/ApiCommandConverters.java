...
public final class ApiCommandConverters {
    ...
    public static exchange.core2.core.common.api.ApiInternalTransfer convertInternalTransfer(ApiCommand apiCommand) {
        var g = apiCommand.getInternalTransfer();
        exchange.core2.core.common.api.ApiInternalTransfer cmd = exchange.core2.core.common.api.ApiInternalTransfer
            .builder().fromUid(g.getFromUid()).toUid(g.getToUid()).currency(g.getCurrency()).amount(g.getAmount())
            .transactionId(g.getTransactionId()).build();
        cmd.updateTimestamp(apiCommand.getTimestamp());
        return cmd;
    }
    ...
    public static exchange.core2.core.common.api.ApiLiquidationScan convertLiquidationScan(ApiCommand apiCommand) {
        var g = apiCommand.getLiquidationScan();
        var cmd = exchange.core2.core.common.api.ApiLiquidationScan.builder()
            .scanSlice(g.getScanSlice()).sliceCount(g.getSliceCount()).build();
        cmd.updateTimestamp(apiCommand.getTimestamp());
        return cmd;
    }
    ...
    public static ApiLoanCreate convertLoanCreate(ApiCommand apiCommand) {
        ...
        ApiLoanCreate cmd = ApiLoanCreate.builder().transactionId(g.getTransactionId()).uid(g.getUid()).loanId(g.getLoanId())
    ...
    public static ApiLoanRepay convertLoanRepay(ApiCommand apiCommand) {
        ...
        ApiLoanRepay cmd = ApiLoanRepay.builder().transactionId(g.getTransactionId()).uid(g.getUid()).loanId(g.getLoanId())
    ...
    public static ApiLoanAddCollateral convertLoanAddCollateral(ApiCommand apiCommand) {
        ...
        ApiLoanAddCollateral cmd = ApiLoanAddCollateral.builder().transactionId(g.getTransactionId()).uid(g.getUid())
    ...
    public static ApiLoanReleaseCollateral convertLoanReleaseCollateral(ApiCommand apiCommand) {
        ...
        ApiLoanReleaseCollateral cmd = ApiLoanReleaseCollateral.builder().transactionId(g.getTransactionId()).uid(g.getUid())
            .loanId(g.getLoanId()).amount(g.getAmount()).build();
        cmd.updateTimestamp(apiCommand.getTimestamp());
        return cmd;
    }
    ...
    public static ApiLoanCrossAddCollateral convertLoanCrossAddCollateral(ApiCommand apiCommand) {
        ...
        ApiLoanCrossAddCollateral cmd = ApiLoanCrossAddCollateral.builder().transactionId(g.getTransactionId())
    ...
    public static ApiLoanCrossWithdrawCollateral convertLoanCrossWithdrawCollateral(ApiCommand apiCommand) {
        ...
        ApiLoanCrossWithdrawCollateral cmd = ApiLoanCrossWithdrawCollateral.builder().transactionId(g.getTransactionId())
            .uid(g.getUid()).currency(g.getCurrency()).amount(g.getAmount()).build();
        cmd.updateTimestamp(apiCommand.getTimestamp());
        return cmd;
    }
    ...
    public static ApiLoanCrossBorrow convertLoanCrossBorrow(ApiCommand apiCommand) {
        ...
        ApiLoanCrossBorrow cmd = ApiLoanCrossBorrow.builder().transactionId(g.getTransactionId()).uid(g.getUid())
            .loanId(g.getLoanId()).symbolId(g.getSymbolId()).principal(g.getPrincipal()).build();
        cmd.updateTimestamp(apiCommand.getTimestamp());
        return cmd;
    }
    ...
    public static ApiLoanCrossRepay convertLoanCrossRepay(ApiCommand apiCommand) {
        ...
        ApiLoanCrossRepay cmd = ApiLoanCrossRepay.builder().transactionId(g.getTransactionId()).uid(g.getUid())
    ...
    public static ApiPoolDeposit convertPoolDeposit(ApiCommand apiCommand) {
        ...
        ApiPoolDeposit cmd = ApiPoolDeposit.builder().shardId(g.getShardId())
    ...
    public static ApiPoolWithdraw convertPoolWithdraw(ApiCommand apiCommand) {
        ...
        ApiPoolWithdraw cmd = ApiPoolWithdraw.builder().shardId(g.getShardId())
            .currency(g.getCurrency()).amount(g.getAmount()).build();
        cmd.updateTimestamp(apiCommand.getTimestamp());
        return cmd;
    }

    public static exchange.core2.core.common.api.ApiLoanIfDeposit convertLoanIfDeposit(ApiCommand apiCommand) {
        var g = apiCommand.getLoanIfDeposit();
        exchange.core2.core.common.api.ApiLoanIfDeposit cmd =
            exchange.core2.core.common.api.ApiLoanIfDeposit.builder()
                .shardId(g.getShardId()).currency(g.getCurrency()).amount(g.getAmount()).build();
        cmd.updateTimestamp(apiCommand.getTimestamp());
        return cmd;
    }

    public static exchange.core2.core.common.api.ApiLoanIfWithdraw convertLoanIfWithdraw(ApiCommand apiCommand) {
        var g = apiCommand.getLoanIfWithdraw();
        exchange.core2.core.common.api.ApiLoanIfWithdraw cmd =
            exchange.core2.core.common.api.ApiLoanIfWithdraw.builder()
                .shardId(g.getShardId()).currency(g.getCurrency()).amount(g.getAmount()).build();
        cmd.updateTimestamp(apiCommand.getTimestamp());
        return cmd;
    }
        ...
        switch (cmd) {
            ...
            case exchange.core2.core.common.api.ApiLiquidationScan ls -> b
                .setLiquidationScan(com.binance.raftexchange.stubs.request.ApiLiquidationScan.newBuilder()
                    .setScanSlice(ls.scanSlice).setSliceCount(ls.sliceCount));
