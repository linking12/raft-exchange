...
public final class CommandRegistry {
    ...
    public CommandRegistry() {
        ...
        register(ApiCommand.CommandCase.INTERNAL_TRANSFER, ApiCommandConverters::convertInternalTransfer);
        ...
        register(ApiCommand.CommandCase.LOAN_IF_DEPOSIT, ApiCommandConverters::convertLoanIfDeposit);
        register(ApiCommand.CommandCase.LOAN_IF_WITHDRAW, ApiCommandConverters::convertLoanIfWithdraw);
