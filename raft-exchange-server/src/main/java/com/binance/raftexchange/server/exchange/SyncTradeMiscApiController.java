...
public class SyncTradeMiscApiController extends AbstractApiController {
     ...
     */
    public static CompletableFuture<StateHashReportResult> getStateHash(StateHashReportQuery grpcStateHashReportQuery, int transferId) throws Exception {
     ...
     */
    public static CompletableFuture<TotalCurrencyBalanceReportResult> getTotalCurrencyBalance(TotalCurrencyBalanceReportQuery grpcTotalCurrencyBalanceReportQuery, int transferId) throws Exception {
