...
import com.binance.raftexchange.server.raft.RaftRoleChangeEventbus;
...
public class IEventsHandlerByKafka implements IEventsHandler {
    ...
    public IEventsHandlerByKafka(KafkaProducer<Long, byte[]> sender, String topic) {
        this.sender = sender;
        this.topic = topic;
        RaftRoleChangeEventbus.INSTANCE.registerListener(nodeType -> isLeader.set(nodeType == RaftNode.NodeType.LEADER));
    }
